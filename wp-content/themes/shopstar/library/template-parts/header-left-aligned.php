...
<header id="masthead" class="site-header left-aligned <?php echo ( get_theme_mod( 'shopstar-show-header-top-bar', customizer_library_get_default( 'shopstar-show-header-top-bar' ) ) ) ? 'has-top-bar' : ''; ?> <?php echo ( get_theme_mod( 'shopstar-header-sticky', customizer_library_get_default( 'shopstar-header-sticky' ) ) ) ? 'sticky' : ''; ?> <?php echo ( get_theme_mod( 'shopstar-header-sticky-logo', customizer_library_get_default( 'shopstar-header-sticky-logo' ) ) ) ? 'include-logo' : 'no-logo'; ?>" role="banner">
	...
	<div class="container <?php echo get_theme_mod( 'shopstar-header-bound', customizer_library_get_default( 'shopstar-header-bound' ) ) == 'shopstar-header-bound-full-width' ? 'full-width' : ''; ?>">
	    <div class="padder">
