...
function shopstar_customizer_library_build_styles() {
	...
	$color = 'shopstar-page-content-background-color';
    ...
    $color = 'shopstar-mobile-menu-button-color';
    $colormod = get_theme_mod( $color, customizer_library_get_default( $color ) );
    ...
    $fontcolor = 'shopstar-top-bar-font-color';
    ...
    $fontsize = 'shopstar-site-title-font-size';
